#!/bin/bash
# ============================================================
# setup_tgd.sh — Genera los ficheros base del proyecto TGD
# Ejecutar desde: /home/juanjo/Escritorio/TGD/
# Uso:  chmod +x setup_tgd.sh && ./setup_tgd.sh
# ============================================================

set -e

echo ""
echo "🔧 Configurando proyecto TGD..."
echo ""
...
# ============================================================
# 1. src/core/secure-store.js
# ============================================================
cat << 'SECURE_STORE_EOF' > src/core/secure-store.js
...
# ============================================================
# 2. src/modules/journal/journal-view.js
# ============================================================
cat << 'JOURNAL_VIEW_EOF' > src/modules/journal/journal-view.js
      ...
      <div className="max-w-5xl mx-auto p-6 space-y-6">
        <header className="space-y-2">
          <h1 className="text-3xl font-bold tracking-tight">
            App educativa segura
          </h1>
          <p className="text-slate-600">
            Prototipo base local-first con diario cifrado y soporte TEA/TGD.
          </p>
        </header>
        ...
        <section className="rounded-2xl border bg-white p-4 space-y-3">
          ...
          <input
            ...
            placeholder="Introduce un PIN para cifrar el diario"
            className="w-full max-w-sm border rounded-xl px-3 py-2 outline-none"
          />

          <p className="text-sm text-slate-500">
            Este PIN no se envía a ningún servidor. Solo se usa en el dispositivo
...
# 5. src/index.css
# ============================================================
cat << 'INDEX_CSS_EOF' > src/index.css
@tailwind base;
@tailwind components;
@tailwind utilities;
...
echo ""
echo "🚀 ¡Proyecto TGD configurado correctamente!"
echo ""
echo "Siguiente paso:"
echo "  npm run dev"
echo ""
